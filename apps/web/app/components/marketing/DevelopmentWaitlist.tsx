  ...
  return (
    <section className={styles.section} aria-labelledby={headingId}>
      <div className={styles.buildingPublic}>
        ...
        <h2 id={headingId}>FretGarden is still in active development.</h2>
        <p>
          ...
          and advanced drills. Cloud progress sync and more lessons are planned.
          They are not live yet. Early testing and direct feedback will help
