...
export const levelFiveLessons: readonly CurriculumLesson[] = [
  {
    ...
    contentBlocks: [
      ...
      ...stages("extended-chords", "functional extensions and color tones", ["Observe a seventh chord before extensions are added.", "Hear 9, 11, and 13 as color over stable guide tones.", "Compare dense grips with clear partial voicings."], ["Build one extended chord from a seventh shell.", "Name which tone is omitted and why.", "Resolve one color tone by step."], ["Use only function labels and color targets.", "Revise any voicing that hides the third or seventh.", "Check register and density after playing."], ["Voice a ii-V-I with intentional extensions.", "Explain each omission, color, and resolution.", "Perform the progression in time with sustainable shapes."], ["Guide tones remain clear.", "Extensions are named and intentional.", "Voicings are playable and functional."]),
    ...
    guidedExercises: [
      ...
      { id: "exercise.extension-resolution", title: "Color-tone resolution", purpose: "Make extensions move musically.", instructions: ["Choose one color tone.", "Resolve it by step or common tone.", "Compare with a static version.", "Keep the smoother option."], successCriteria: ["The color tone is tracked.", "Resolution is audible.", "Function remains clear."], reduceDifficultyWhen: ["Resolve one note only."], increaseDifficultyWhen: ["Use a full ii-V-I in two keys."], relatedSkills: ["resolution", "guide tones", "arrangement"] }
    ],
    commonMistakes: [
    ...
    masteryCriteria: [
      ...
      { id: "mastery.extension-resolve", description: "Resolve at least one color tone intentionally.", verification: "guided-self-check", required: true }
    ],
    reviewRecommendation: "Next session, build every extension from a seventh shell. After one week, revoice the same progression with fewer notes and clearer color.",
  ...
  },
  {
    ...
    objective: "Choose chord-scale options from chord quality, function, and resolution rather than from one memorized scale grid.",
    ...
    contentBlocks: [
      ...
      ...stages("chord-scale", "contextual chord-scale selection", ["Observe chord tones before collections.", "Hear stable tonic color versus resolving dominant color.", "Compare scale choice with target-note choice."], ["Name chord quality and function.", "Choose one collection and one avoid or tension note.", "Resolve the strongest tension."], ["Hide the collection label and use target tones first.", "Add only two color tones.", "Check whether the line follows the harmony."], ["Choose collections for a four-chord progression.", "Perform a short line that targets chord tones and uses color deliberately.", "Explain the resolution logic."], ["Chord quality and function are named.", "Targets land on strong beats.", "Scale color resolves or sustains by intention."]),
    ...
    commonMistakes: [
      { id: "mistake.scale-grid", symptom: "One scale shape is used over every chord.", likelyCause: "Collection labels replaced harmonic function.", adjustment: "Name chord quality and target tones first." },
  ...
  },
  {
    ...
    whyItMatters: "Modulation expands form. A key change should feel prepared, confirmed, and musically necessary rather than pasted onto the song.",
    estimatedMinutes: 155,
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      ], explanation: "G sharp supplies leading-tone pull; F or F sharp changes the melodic-minor color. Track altered notes instead of memorizing a label only.", accessibilityDescription: "A minor ii-V-i color chart: B half-diminished, E seven flat nine, A minor major seven, A minor six." },
      ...stages("advanced-minor", "harmonic and melodic minor application", ["Hear natural, harmonic, and melodic minor over one tonic.", "Observe minor ii-V-i color and altered dominant pull.", "Compare minor-major tonic color with ordinary minor seven."], ["Name changed degrees 6 and 7.", "Target guide tones through ii-V-i.", "Resolve altered dominant color to tonic minor."], ["Use chord symbols only.", "Add one melodic-minor color to tonic.", "Check whether altered notes have a job."], ["Perform a minor ii-V-i with named color choices.", "Explain harmonic and melodic minor usage.", "Write a short phrase using altered degrees intentionally."], ["Changed degrees are named.", "Dominant tension resolves.", "Minor color matches the chord function."]),
    ...
    knowledgeChecks: [
      ...
      { id: "check.advanced-minor-job", prompt: "What should every altered degree have?", options: ["A color or resolution job", "No explanation", "Only speed"], correctAnswer: "A color or resolution job", explanation: "Altered degrees should be chosen intentionally." }
    ],
    masteryCriteria: [
  ...
  },
  {
    ...
    objective: "Integrate bends, slides, legato, hybrid picking, muting, and position shifts as phrasing choices rather than isolated speed goals.",
    ...
    knowledgeChecks: [
      { id: "check.technique-purpose", prompt: "What makes technique musical?", options: ["It serves phrasing, tone, timing, or articulation", "It is always fast", "It uses every fret"], correctAnswer: "It serves phrasing, tone, timing, or articulation", explanation: "Technique is vocabulary when it communicates." },
  ...
  },
  {
    ...
    commonMistakes: [
      ...
      { id: "mistake.reharm-too-many", symptom: "Every chord changes and the phrase loses identity.", likelyCause: "Novelty replaced direction.", adjustment: "Change one structural point first and compare." }
    ],
    knowledgeChecks: [
    ...
    masteryCriteria: [
      ...
      { id: "mastery.reharm-melody", description: "Account for strong melody notes over every changed chord.", verification: "guided-self-check", required: true }
    ],
  ...
  },
  {
    ...
    objective: "Integrate advanced harmony, modulation, minor systems, technique, form, and reharmonization into a jury portfolio with analysis, performance, and next-study evidence.",
    ...
    contentBlocks: [
      { id: "jury-scope", type: "text", heading: "The jury is a portfolio defense", paragraphs: ["Prepare one complete performance or arrangement plus two supporting studies. The complete work should show advanced harmony, form, and technical vocabulary used for musical reasons.", "Required evidence: chart, analysis, technique-purpose audit, reharmonization or modulation map, reflection, and a four-week next-study plan."] },
      ...
      { id: "jury-evidence", type: "instrument-setup", heading: "Jury evidence checklist", items: [
        ...
        { label: "Analysis", instruction: "Label advanced harmony, modulation, substitutions, and form.", selfCheck: "Every advanced choice has a musical reason." },
        ...
        { label: "Next plan", instruction: "Write a four-week plan from the weakest evidence.", selfCheck: "The plan has tasks, tempos, review days, and criteria." }
      ...
      ...stages("level-five-jury", "advanced musicianship jury", ["Review the complete work and supporting-study requirements.", "Observe how advanced concepts are defended by analysis.", "Identify the weakest domain before final polish."], ["Draft chart, analysis, and supporting studies.", "Run partial takes and repair one weak transition.", "Attach technique and reharm maps as evidence."], ["Run complete takes with only a jury checklist.", "Revise the weakest evidence artifact.", "Reduce prompts to form cues and concept labels."], ["Present the complete jury portfolio.", "Explain advanced choices and evidence.", "Write the next four-week plan from observed weakness."], ["The performance is complete and recoverable.", "Analysis matches the music.", "Next study follows evidence rather than novelty."]),
      { id: "jury-reflection", type: "reflection", heading: "Defend the next study direction", prompt: "Summarize the performance, supporting studies, advanced choices, weakest domain, and the four-week plan that follows from the evidence.", fieldLabel: "Advanced jury reflection", placeholder: "Weakest domain: modulation transitions. Week 1 maps pivots; Week 2 practices boundaries; Week 3 records two keys; Week 4 performs full form." }
    ],
    guidedExercises: [
      ...
      { id: "exercise.jury-defense", title: "Evidence defense", purpose: "Make advanced choices explainable.", instructions: ["Attach the chart.", "Label advanced choices.", "Audit technique vocabulary.", "Write the next-study plan."], successCriteria: ["Evidence matches performance.", "Choices have reasons.", "The next plan is specific."], reduceDifficultyWhen: ["Use the template chart."], increaseDifficultyWhen: ["Prepare an alternate reharmonized ending."], relatedSkills: ["portfolio", "reflection", "planning"] }
    ],
    commonMistakes: [
      ...
      { id: "mistake.jury-plan", symptom: "The final plan is generic.", likelyCause: "Weak evidence was not identified.", adjustment: "Choose one weak domain and write weekly evidence criteria." }
    ],
    knowledgeChecks: [
      ...
      { id: "check.jury-evidence", prompt: "What should advanced analysis match?", options: ["The performed music", "A separate unrelated theory list", "Only the easiest chord"], correctAnswer: "The performed music", explanation: "Evidence must describe the actual artifact." },
      { id: "check.jury-next", prompt: "Where should the next plan come from?", options: ["The weakest observed evidence", "Random novelty", "Avoiding review"], correctAnswer: "The weakest observed evidence", explanation: "Advanced practice should follow evidence." }
    ],
    masteryCriteria: [
      ...
      { id: "mastery.jury-plan", description: "Write a four-week next-study plan from weakest evidence.", verification: "reflection", required: true }
    ],
    reviewRecommendation: "After the jury, revisit the weakest-domain plan weekly before starting Level 6 artistic-identity work.",
...
export const levelFiveReviewPlans: readonly CurriculumReviewPlan[] = [
  ...
  { id: "review.level-five-advanced-musicianship-jury", unitId: "unit.level-five-advanced-musicianship-jury", immediateReview: ["List jury artifacts and weakest evidence domain."], nextSessionReview: ["Run the full form and repair one weak transition."], oneWeekReview: ["Check that performance, analysis, technique audit, and next plan agree."], longTermReview: ["Use the jury's weakest evidence to choose Level 6 artistic-identity work."] }
];
