...
export const levelThreeLessons: readonly CurriculumLesson[] = [
  {
    ...
    contentBlocks: [
      { id: "caged-system-purpose", type: "text", heading: "Five regions overlap into one fretboard", paragraphs: ["The open C, A, G, E, and D chord forms can be moved to describe five neighboring regions for one major harmony. The form name describes interval geometry, not the sounding chord name.", "Anchor each region with named roots and chord tones. Use partial voicings when they make register, tone, or physical comfort clearer; do not treat difficult full grips as the definition of knowledge."] },
      ...
      ...stages("caged-five-regions", "five connected CAGED regions", ["Trace each C root before viewing its form.", "Name 1, 3, and 5 inside each C voicing.", "Hear one progression revoiced low, middle, and high."], ["Build partial C forms from one root and two chord tones.", "Connect C-form to A-form, then A-form to G-form without stopping.", "Assign verse, chorus, and bridge to three registers."], ["Use root markers and reconstruct interval maps.", "Play three randomly named regions before checking diagrams.", "Choose partial voicings by register instead of grip familiarity."], ["Locate C major in all five regions from memory.", "Repeat the process for a second named major chord.", "Perform one song form using at least three regions and explain each choice."], ["Voicings contain the named chord tones.", "Roots and intervals are named without relying on form labels alone.", "Register changes support section contrast and transitions remain in time."]),
    ...
    guidedExercises: [
      { id: "exercise.caged-root-first", title: "Root before region", purpose: "Prevent shape recall from replacing note knowledge.", instructions: ["Choose a major chord name.", "Find one root on strings 6, 5, or 4.", "Build the nearest 1-3-5 fragment.", "Name the neighboring CAGED region after checking tones."], successCriteria: ["The root is named before the form.", "Sounded notes are 1, 3, or 5.", "The fragment transfers to a second register."], reduceDifficultyWhen: ["Use C major and strings 4-2."], increaseDifficultyWhen: ["Use a shuffled flat or sharp root."], relatedSkills: ["CAGED", "fretboard", "intervals"] },
      { id: "exercise.caged-song-regions", title: "Three-region arrangement", purpose: "Use neck position as an arrangement decision.", instructions: ["Map one progression in a low region.", "Find compact middle-register alternatives.", "Choose an upper-register bridge or response.", "Perform the form with planned transitions."], successCriteria: ["At least three regions are audible.", "Chord identity remains accurate.", "Register changes coincide with form purpose."], reduceDifficultyWhen: ["Change region for the chorus."], increaseDifficultyWhen: ["Add a nearby major-scale fill without losing chord tones."], relatedSkills: ["arrangement", "voicing", "form"] }
    ],
    commonMistakes: [
      ...
      { id: "mistake.caged-all-strings", symptom: "Regions get forced into tense six-string chords.", likelyCause: "Completeness is being confused with musical usefulness.", adjustment: "Choose a three- or four-note fragment that preserves the needed register." },
      { id: "mistake.caged-transition", symptom: "Register changes interrupt the form.", likelyCause: "Regions were practiced alone, without section boundaries.", adjustment: "Loop the final beat of one section into the first chord of the next." }
    ],
    knowledgeChecks: [
  ...
  },
  {
    ...
    guidedExercises: [
      { id: "exercise.major-harmonize", title: "Sing, stack, verify", purpose: "Derive diatonic triads before checking a chart.", instructions: ["Write or speak the major scale.", "Sing each root in order.", "Stack scale degrees 1-3-5 above each root.", "Name quality and verify on guitar."], successCriteria: ["Seven roots remain in key.", "Quality pattern is major-minor-minor-major-major-minor-diminished.", "Inversions connect with small motion."], reduceDifficultyWhen: ["Harmonize degrees I, IV, and V."], increaseDifficultyWhen: ["Use a key with two or more accidentals."], relatedSkills: ["diatonic harmony", "triads", "singing"] },
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      { id: "a-melodic-minor", type: "scale-pattern", heading: "A melodic minor raises degrees 6 and 7", root: "A", collectionName: "melodic minor ascending", formulaSemitones: [0,2,3,5,7,9,11], notes: ["A","B","C","D","E","F#","G#"], degrees: ["1","2","b3","4","5","6","7"], positions: [
        ...
        { string: 3, fret: 1, degree: "7" }, { string: 3, fret: 2, degree: "1" }
      ], explanation: "Raised F sharp smooths the melodic route toward G sharp and A. Compare all three forms over a sustained A so you hear the changed degrees.", accessibilityDescription: "A melodic minor ascending changes F and G to F sharp at string 4 fret 4 and G sharp at string 3 fret 1." },
      ...
      ], explanation: "Natural minor gives minor v. Borrowing raised degree 7 from harmonic minor creates major V and a stronger V-i cadence. Label the altered G sharp so the chord change stays honest.", accessibilityDescription: "A-minor function map: A minor i, D minor iv, E minor v, E major V with G sharp, C major III, and G major VII." },
      { id: "minor-relative-song", type: "lead-sheet", heading: "Contrast tonic identity and chord inventory", songTitle: "After the Rainline", key: "A", meter: "6/8", tempo: 68, capo: 0, sections: [
      ...
      { id: "minor-color-reflection", type: "reflection", heading: "Give each altered degree a job", prompt: "Describe where natural, harmonic, or melodic minor appears in your progression or melody; identify the relative and parallel major references; and explain one leading-tone resolution.", fieldLabel: "Minor-system analysis", placeholder: "Verse melody uses natural G over VII, then G sharp over E major to lead into A minor. Chorus shifts tonic focus to C major." }
    ],
    guidedExercises: [
    ...
    commonMistakes: [
      { id: "mistake.minor-one-form", symptom: "Minor contexts get treated as natural minor.", likelyCause: "Scale shape has replaced harmonic listening.", adjustment: "Compare degree 7 over minor v and major V, then choose by function." },
  ...
  },
  {
    ...
    whyItMatters: "Seventh chords make harmony more specific. When the third and seventh are clear, rhythm parts sound planned and solos begin to follow the chord changes instead of floating above them.",
    estimatedMinutes: 150,
    priorKnowledge: ["Triad formulas", "Minor and major diatonic harmony", "Movable roots", "Chord-tone naming", "Basic improvisation"],
    contentBlocks: [
      { id: "seventh-quality-text", type: "text", heading: "Sevenths add function and color", paragraphs: ["A seventh chord adds one more stacked third to a triad. Major seventh sounds stable and luminous; minor seventh softens minor harmony; dominant seventh contains a major third and minor seventh that pull toward resolution.", "Half-diminished seventh is a diminished triad plus a minor seventh. Fully diminished seventh stacks minor thirds. Learn each quality by formula, guide tones, and sound before choosing a grip."] },
      ...
      ], explanation: "Hear the major seventh B as color, not as a passing mistake. Resolve it down to A or up to C by choice.", accessibilityDescription: "C major seven arpeggio: string 5 fret 3 C, string 4 fret 2 E, string 4 fret 5 G, string 3 fret 4 B." },
      ...
      ], explanation: "Fully diminished seventh chords are symmetrical. Name the chord by its function and resolution before using the repeating shape.", accessibilityDescription: "B diminished seven arpeggio: string 5 fret 2 B, string 5 fret 5 D, string 4 fret 3 F, string 4 fret 6 A flat." },
      ...
      { id: "seventh-reflection", type: "reflection", heading: "Name the notes that carried the harmony", prompt: "For one short solo pass, list the third and seventh of each chord, circle the notes that landed on beats 1 or 3, and describe one resolution you heard.", fieldLabel: "Guide-tone notes", placeholder: "Over G7 I landed B on beat 1 and F on beat 3, then resolved B to C in the next measure." }
    ],
    guidedExercises: [
  ...
  },
  {
    ...
    order: 1,
    title: "Develop one idea until it sounds connected",
    ...
    commonMistakes: [
      { id: "mistake.motif-copy", symptom: "Phrases stay identical.", likelyCause: "Recognition is being confused with exact repetition.", adjustment: "Keep rhythm but change direction or ending." },
  ...
  },
  {
    ...
    whyItMatters: "Chord-tone improvisation turns a scale into a map of moments. The listener can hear the progression inside the line because strong beats land on notes from the current chord.",
    estimatedMinutes: 145,
    ...
    contentBlocks: [
      ...
      { id: "chord-tone-reflection", type: "reflection", heading: "Review the solo like a musician", prompt: "Write the target note for each measure, identify two non-chord tones and their jobs, and explain where the line reveals the progression.", fieldLabel: "Chord-tone solo notes", placeholder: "Measure 4 targets B and F for G7; C anticipates Cmaj7 before resolving into the final measure." }
    ],
    guidedExercises: [
      ...
      { id: "exercise.eight-bar-solo", title: "Compose before improvising", purpose: "Make the target notes visible before the solo changes.", instructions: ["Write targets for eight bars.", "Compose one simple line using those targets.", "Perform it twice, then alter two measures in the moment.", "Keep written notes on changed pitches."], successCriteria: ["Written and performed targets match.", "Altered measures still follow harmony.", "The final take has clear beginning, middle, and ending."], reduceDifficultyWhen: ["Compose four bars first."], increaseDifficultyWhen: ["Transpose to a new key."], relatedSkills: ["soloing", "composition", "analysis"] }
    ],
    commonMistakes: [
      { id: "mistake.chord-tone-root-jump", symptom: "Chord changes keep leaping to the root.", likelyCause: "Root knowledge is being used without voice-leading awareness.", adjustment: "Find the nearest third or seventh instead." },
      ...
      { id: "mistake.chord-tone-static", symptom: "The same pentatonic phrase repeats over the chords.", likelyCause: "The line is not responding to harmonic context.", adjustment: "Write one forced target for each measure before improvising." }
    ],
    knowledgeChecks: [
      ...
      { id: "check.chord-tone-nearest", prompt: "Why use the nearest chord tone at a change?", options: ["It creates smooth voice leading", "It makes every chord sound the same", "It prevents analysis"], correctAnswer: "It creates smooth voice leading", explanation: "Small motion often sounds connected and planned." }
    ],
    masteryCriteria: [
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      ], explanation: "Start with one readable chart. Then assign roles: low rhythm, upper triads, counterline, or planned rests.", accessibilityDescription: "Original G song: verse G Em C D, chorus C G D Em, tag C D G." },
      ...
      { id: "arrangement-setup", type: "instrument-setup", heading: "Check tone and collision before performance", items: [
        ...
        { label: "Density", instruction: "Remove one strum or note when the words, melody, or cue becomes hidden.", selfCheck: "The main idea remains easiest to hear." },
        { label: "Articulation", instruction: "Use muted, sustained, picked, and brushed sounds for different roles.", selfCheck: "Parts differ in touch as well as pitch." }
    ...
    commonMistakes: [
      { id: "mistake.arrangement-crowded", symptom: "Parts strum the same rhythm in the same register.", likelyCause: "Layering was treated as duplication.", adjustment: "Assign one part rhythm, one part sustained color, and one part rests or answers." },
    ...
    reviewRecommendation: "Next session, replay the same chart with one fewer note in each part. After one week, arrange a new progression with a different register plan.",
  ...
  },
  {
    ...
    whyItMatters: "A level project shows whether skills work together under musical pressure. Build a clear portfolio artifact with analysis, recovery, reflection, and a plan for the next weak area.",
    estimatedMinutes: 240,
    priorKnowledge: ["All Level 1-3 units", "Functional harmony", "Motif development", "Chord-tone improvisation", "Arrangement mapping"],
    contentBlocks: [
      { id: "level-three-project-scope", type: "text", heading: "The project shows integrated musicianship", paragraphs: ["Prepare a two- to four-minute performance or documented arrangement that includes contrasting sections, rhythm-guitar control, melodic material, triads or sevenths, and a short improvised or composed lead passage.", "Prepare supporting notes for yourself: Roman or Nashville analysis, a short transcription, an arrangement map, and a four-week practice plan for the weakest area. Gate 4 human review remains deferred for release, but the learner-facing project can still organize the artifacts."] },
      ...
      { id: "project-evidence-checklist", type: "instrument-setup", heading: "Portfolio notes checklist", items: [
        ...
        { label: "Analysis", instruction: "Write Roman or Nashville function for each section.", selfCheck: "Each chord has a relationship and a name." },
        ...
        { label: "Practice plan", instruction: "Choose the weakest area and create a four-week plan.", selfCheck: "The plan names tasks, tempos, review days, and success checks." }
      ...
      ...stages("level-three-project", "integrated Level 3 performance project", ["Review examples of performance, analysis, arrangement map, transcription, and practice-plan notes.", "Observe how the model chart combines rhythm, harmony, lead, and form.", "Identify the weak area before planning final polish."], ["Choose or write the project chart.", "Draft rhythm, lead, and arrangement roles.", "Create analysis and transcription notes alongside practice."], ["Run complete takes with a short project checklist.", "Revise the weakest section instead of restarting everything.", "Reduce prompts to form cues and target notes."], ["Perform or document the complete project.", "Submit analysis, transcription, arrangement map, and four-week weak-area plan.", "Reflect on recovery, accuracy, musicality, and next learning target."], ["The form is complete and recoverable.", "Analysis and performance agree.", "Project notes cover rhythm, harmony, melody, arrangement, transcription, and reflection."]),
      { id: "project-reflection", type: "reflection", heading: "Close Level 3 with a next-practice plan", prompt: "Summarize the project, identify the strongest and weakest areas, list the project artifacts, and write a four-week plan with tempos, review days, and success criteria.", fieldLabel: "Level 3 project reflection", placeholder: "Weakest area: chord-tone soloing. Week 1 targets guide tones at 60 BPM; Week 2 adds approaches at 70 BPM; Week 3 transposes; Week 4 records a full take." }
    ],
    guidedExercises: [
      ...
      { id: "exercise.project-portfolio", title: "Project notes packet", purpose: "Make musicianship visible for review.", instructions: ["Prepare a chart with function labels.", "Attach a short transcription.", "Write an arrangement map.", "Create a four-week weak-area plan."], successCriteria: ["Each artifact matches the performance.", "The transcription can be replayed.", "The practice plan has measurable review points."], reduceDifficultyWhen: ["Use the model project template."], increaseDifficultyWhen: ["Transpose the project to a second key."], relatedSkills: ["analysis", "transcription", "practice planning"] }
    ],
    commonMistakes: [
      { id: "mistake.project-perfect", symptom: "The learner restarts after small errors.", likelyCause: "The project is being confused with perfection.", adjustment: "Require complete takes and write recovery notes after the form ends." },
      { id: "mistake.project-artifacts", symptom: "The performance exists but analysis or transcription is missing.", likelyCause: "Portfolio notes were left until the end.", adjustment: "Create artifacts while arranging, then revise them after final takes." },
      { id: "mistake.project-weak-plan", symptom: "The next plan says practice more without specifics.", likelyCause: "Weak areas were named without tasks or success checks.", adjustment: "Define tempo, reps, review date, and success criteria for each week." }
    ],
    knowledgeChecks: [
      { id: "check.project-evidence", prompt: "What makes the project more than a performance take?", options: ["Supporting analysis, transcription, arrangement, reflection, and a practice plan", "Only a faster tempo", "Only a longer song"], correctAnswer: "Supporting analysis, transcription, arrangement, reflection, and a practice plan", explanation: "The project shows integrated musicianship through performance and supporting notes." },
      ...
      { id: "check.project-plan", prompt: "What should a weak-area plan include?", options: ["Tasks, tempos, review days, and success criteria", "Only a vague goal", "Only new songs"], correctAnswer: "Tasks, tempos, review days, and success criteria", explanation: "Specific details make the next phase trainable." }
    ],
    masteryCriteria: [
      ...
      { id: "mastery.project-plan", description: "Create a four-week plan for the weakest area with success targets.", verification: "reflection", required: true }
    ],
