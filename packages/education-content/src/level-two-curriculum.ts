...
export const levelTwoLessons: readonly CurriculumLesson[] = [
  ...
  },
  {
    ...
    objective: "Plan and perform a two-to-four-minute original piece with a readable chart, contrasting sections, rhythm and lead roles, one improvised passage, a short ear transcription, functional analysis, and evidence-based self-evaluation.",
    ...
    contentBlocks: [
      ...
      ...stages("level-two-integration", "a complete Level 2 piece", ["Trace the model form and identify the job of every guitar part.", "Hear how accompaniment density changes between verse and chorus.", "Observe a transcription cycle that delays notation until after hearing and singing."], ["Sketch three contrasting 30-60 second studies: groove-led, melody-led, and form-led.", "Choose one study and draft a complete lead sheet with section, repeat, cue, and ending information.", "Rehearse rhythm and lead roles separately before combining them."], ["Use only the chart and a short transition checklist.", "Remove written scale diagrams during the fixed improvisation section.", "Run the entire form after mistakes without restarting, then repair only the weak transition."], ["Perform the original two-to-four-minute piece from its chart.", "Complete the short ear transcription without viewing an answer first.", "Submit the chart, functional analysis, performance checklist, and evidence-based self-evaluation."], ["Pulse, form, and section lengths remain recoverable from beginning to ending.", "Rhythm, melody, and improvisation serve distinct musical roles.", "The chart and analysis let another musician understand the intended piece.", "Reflection cites observable musical evidence and a specific next exercise."]),
      { id: "level-two-project-reflection", type: "reflection", heading: "Evaluate decisions, not personality", prompt: "Record the key, meter, form, progression functions, chosen scale or note collection, strongest transition, least stable moment, recovery evidence, and one narrowly defined next exercise. Also name why the selected study offered stronger evidence than the other two.", fieldLabel: "Level 2 project evaluation", placeholder: "G major, 4/4, A-B-A-solo-B. The chorus entry stayed in time; the solo ending over V was late. Next: loop the final two solo bars into the chorus at 60 BPM." }
    ],
    guidedExercises: [
      { id: "exercise.level-two-three-sketches", title: "Three contrasting studies", purpose: "Separate exploration from final-project polishing.", instructions: ["Make a groove-led sketch with a clear mute or syncopation choice.", "Make a melody-led sketch with a developed motive.", "Make a form-led sketch with at least two contrasting sections.", "Choose one using the published success criteria."], successCriteria: ["Each sketch has a different primary musical problem.", "The choice is justified by evidence rather than familiarity alone.", "Useful material from unselected sketches is recorded."], reduceDifficultyWhen: ["Limit each sketch to 30 seconds and two chords."], increaseDifficultyWhen: ["Transpose one sketch or arrange it for a second guitar role."], relatedSkills: ["composition", "selection", "reflection"] },
      { id: "exercise.level-two-performance-run", title: "No-restart project run", purpose: "Test complete-form recovery rather than isolated perfection.", instructions: ["Count in and perform the entire chart without restarting.", "Mark only lost form, pulse breaks, unclear roles, and failed transitions.", "Choose the highest-impact issue and isolate it for five minutes.", "Run the complete form again."], successCriteria: ["The ending arrives after the intended form.", "Mistakes do not erase the pulse or next section.", "The second run tests one deliberate repair."], reduceDifficultyWhen: ["Run intro, one verse, one chorus, and outro."], increaseDifficultyWhen: ["Change tempo, register, or ensemble context without changing form."], relatedSkills: ["performance", "recovery", "form"] },
      { id: "exercise.level-two-transcription", title: "Hear, sing, find, write, verify", purpose: "Produce listening evidence independent of a visible fret pattern.", instructions: ["Listen to a two-to-four-note source at least three times without the guitar.", "Sing the contour and tap the rhythm.", "Find one pitch at a time and name known notes or intervals.", "Write rhythm and fret locations, then verify against the source."], successCriteria: ["The first search follows the heard contour.", "Rhythm and pitch are written separately when needed.", "Corrections are marked rather than erased from the learning record."], reduceDifficultyWhen: ["Use two notes with quarter-note rhythm."], increaseDifficultyWhen: ["Use a changed key, register, or starting string."], relatedSkills: ["ear training", "transcription", "fretboard"] }
    ],
    commonMistakes: [
      { id: "mistake.level-two-overload", symptom: "The piece contains every recently learned device but no clear musical center.", likelyCause: "Feature count has replaced arrangement purpose.", adjustment: "Give each section one primary job and remove anything that competes with it." },
      ...
      { id: "mistake.level-two-restart", symptom: "Every error sends the performance back to bar one.", likelyCause: "Isolated accuracy has not been connected to form recovery.", adjustment: "Practice entering at every section and run the chart with a no-restart rule." },
    ...
    knowledgeChecks: [
      { id: "check.level-two-evidence", prompt: "Which result provides the strongest integration evidence?", options: ["A complete recoverable performance plus chart, analysis, and reflection", "A flawless isolated scale", "A list of every chord shape learned"], correctAnswer: "A complete recoverable performance plus chart, analysis, and reflection", explanation: "Integration requires skills to remain available inside a complete musical form and to be explained with evidence." },
      { id: "check.level-two-arrangement", prompt: "What should a second guitar role do by default?", options: ["Occupy a complementary register, rhythm, or function", "Double every note continuously", "Play louder than the first part"], correctAnswer: "Occupy a complementary register, rhythm, or function", explanation: "Complementary roles preserve clarity and create meaningful ensemble evidence." },
      { id: "check.level-two-transcription", prompt: "What comes before searching the fretboard in the transcription cycle?", options: ["Hear the source and sing or tap its contour and rhythm", "Read a completed tab", "Choose a familiar scale shape at random"], correctAnswer: "Hear the source and sing or tap its contour and rhythm", explanation: "Delayed visual support makes the task evidence of listening rather than copying." }
    ],
    masteryCriteria: [
      ...
      { id: "mastery.level-two-reflection", description: "Cite observable performance evidence and define one targeted next exercise.", verification: "reflection", required: true }
    ],
...
export const levelTwoReviewPlans: readonly CurriculumReviewPlan[] = [
  ...
  { id: "review.level-two-band-songwriting-project", unitId: "unit.level-two-band-songwriting-project", immediateReview: ["Record the strongest evidence, weakest transition, and exact next exercise."], nextSessionReview: ["Retrieve the chart and repair the weakest transition before a complete no-restart run."], oneWeekReview: ["Perform in a changed tempo, key, register, or ensemble context."], longTermReview: ["Revisit the project after later levels and document how arrangement, harmony, and improvisation choices changed."] }
];
