...
export const levelFourLessons: readonly CurriculumLesson[] = [
  {
    ...
    contentBlocks: [
      ...
      ...stages("modal-sounds", "modal center and characteristic color", ["Hear D Dorian against a D drone.", "Hear G Mixolydian against a G drone.", "Compare modal color with ordinary major and minor function."], ["Play the pattern while returning to the center.", "Target the characteristic degree on a strong beat.", "Write a two-chord vamp that does not resolve like major-key harmony."], ["Use only degree names and a drone.", "Compose a four-bar phrase without the diagram.", "Check whether the center still sounds stable."], ["Perform two modal studies and name the color degree.", "Explain why each is not simply a major scale from another note.", "Transpose one mode to a new root."], ["The tonal center is audible.", "The characteristic degree is emphasized.", "The phrase avoids misleading functional resolution."]),
      { id: "modal-reflection", type: "reflection", heading: "Defend the modal center", prompt: "Name the mode, center, color degree, vamp, and two melody notes that prove the mode is being heard rather than merely fingered.", fieldLabel: "Modal evidence", placeholder: "D Dorian: D is repeated as center; B natural appears on beat 3; Dm7-G avoids C-major resolution." }
    ],
    guidedExercises: [
    ...
    commonMistakes: [
      ...
      { id: "mistake.modal-color", symptom: "The mode is technically correct but not recognizable.", likelyCause: "The characteristic degree is missing or hidden.", adjustment: "Place the color degree on a strong beat and compare it against ordinary major or minor." },
  ...
  },
  {
    ...
    contentBlocks: [
      { id: "secondary-dominant-definition", type: "text", heading: "A secondary dominant points at a chord inside the key", paragraphs: ["In C major, Dm is ii. Its dominant is A7, so A7 can be labeled V7/ii when it resolves to Dm. The slash means dominant of the target chord.", "Secondary dominants usually contain accidentals outside the key. Those altered notes must resolve intentionally; otherwise the chord sounds random rather than directed."] },
    ...
    reviewRecommendation: "Next session, build V7 of every diatonic triad in a key. After one week, analyze secondary dominants in a new chart.",
  ...
  },
  {
    ...
    commonMistakes: [
      ...
      { id: "mistake.mixture-overuse", symptom: "Every chord is borrowed and the tonic disappears.", likelyCause: "Color replaced harmonic direction.", adjustment: "Return to I and use borrowed chords at structural moments." }
    ],
    knowledgeChecks: [
  ...
  },
  {
    ...
    order: 1,
    title: "Let every voice move on purpose",
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      ], explanation: "The chart stores the phrase plan in 4/4-compatible measures while the cue names the seven-pulse grouping. The learner evidence is the counted grouping and clean return.", accessibilityDescription: "Original rhythm study alternates an E minor to D seven-pulse riff with a G A E minor four-four release." },
    ...
    commonMistakes: [
      ...
      { id: "mistake.rhythm-complexity", symptom: "Every section is complex and the listener loses shape.", likelyCause: "Contrast was not planned.", adjustment: "Pair the advanced grouping with a simpler release." }
    ],
    knowledgeChecks: [
  ...
  },
  {
    ...
    objective: "Analyze genre vocabulary through rhythm, tone, harmony, articulation, form, and cultural context, then create a short study that uses vocabulary respectfully and intentionally.",
    ...
    contentBlocks: [
      ...
      ...stages("genre-language", "style vocabulary with context", ["Observe groove, tone, articulation, harmony, and role separately.", "Hear how the same chords change across feel.", "Identify cultural or historical context for the vocabulary."], ["Choose one style element to practice.", "Create an original two-bar study.", "Document source observations without copying material."], ["Remove the checklist and listen for authenticity of role.", "Revise tone or rhythm before adding more notes.", "Ask whether the part serves the ensemble."], ["Create and perform a short original style study.", "Explain musical vocabulary and context.", "Name what you intentionally did not imitate."], ["The study uses specific vocabulary.", "The explanation avoids stereotypes and vague labels.", "The part has a clear musical role."]),
      { id: "genre-reflection", type: "reflection", heading: "Describe vocabulary and responsibility", prompt: "Name the style being studied, list musical observations, identify one context source, and explain how your original study uses vocabulary without copying a recording.", fieldLabel: "Style study notes", placeholder: "I studied pocket rhythm and muted articulation; my original two-bar part uses space on beat 3 rather than copying a recorded riff." }
    ],
    guidedExercises: [
  ...
  },
  {
    ...
    guidedExercises: [
      { id: "exercise.counterpoint-one-line", title: "Singable line first", purpose: "Prevent vertical interval math from replacing melody.", instructions: ["Write one four-bar melody.", "Sing it without guitar.", "Add a lower line mostly in contrary motion.", "Check the vertical sound on strong beats."], successCriteria: ["Each line can be sung alone.", "Strong beats match the harmony.", "Contrary motion appears intentionally."], reduceDifficultyWhen: ["Use half notes only."], increaseDifficultyWhen: ["Add one prepared suspension."], relatedSkills: ["counterpoint", "melody", "harmony"] },
    ...
    knowledgeChecks: [
      ...
      { id: "check.counterpoint-dissonance", prompt: "What should happen to most dissonances in this study?", options: ["They should be prepared or resolved", "They should be ignored", "They should replace the meter"], correctAnswer: "They should be prepared or resolved", explanation: "Treatment makes dissonance sound intentional." },
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      ], explanation: "Use this template or an equivalent original piece. The portfolio must show choices from several Level 4 domains, not every possible concept.", accessibilityDescription: "Level 4 portfolio template: A Dorian section Am7 D Am7 G; chromatic section C E7 Am F; line study Dm7 G7 Cmaj7." },
      { id: "portfolio-evidence-checklist", type: "instrument-setup", heading: "Level 4 evidence checklist", items: [
        { label: "Harmonic color", instruction: "Include modal color, secondary dominant, or modal mixture and label the source.", selfCheck: "The color is audible and not just named." },
        ...
        { label: "Plan", instruction: "Write the next four-week plan from the weakest artifact.", selfCheck: "Tasks, tempos, review dates, and evidence are specific." }
      ...
      ...stages("level-four-portfolio", "upper-intermediate creative portfolio", ["Review examples of harmonic color, advanced rhythm, style study, and line writing.", "Observe how one template combines several domains.", "Identify the weakest domain before final polish."], ["Draft three artifacts.", "Choose one to expand into a complete performance.", "Create analysis and reflection as you build."], ["Run complete takes with a short checklist.", "Revise the weakest artifact first.", "Reduce prompts to form cues and concept labels."], ["Present the portfolio artifacts and one complete performance.", "Explain concept choices and evidence.", "Write the next four-week plan."], ["Artifacts show distinct Level 4 domains.", "Analysis matches the performed material.", "The next plan is specific and evidence-based."]),
      { id: "portfolio-reflection", type: "reflection", heading: "Choose the next mountain deliberately", prompt: "Summarize the three artifacts, identify the strongest and weakest Level 4 domains, cite the evidence, and write the next four-week plan.", fieldLabel: "Level 4 portfolio reflection", placeholder: "Strongest: modal writing. Weakest: counterpoint. Week 1 sings both lines at 60 BPM; Week 2 adds prepared dissonance; Week 3 arranges chord melody; Week 4 records a complete take." }
    ],
    guidedExercises: [
      ...
      { id: "exercise.portfolio-evidence", title: "Evidence before polish", purpose: "Make creative decisions reviewable.", instructions: ["Attach analysis to every artifact.", "Record or describe one complete take.", "Write a reflection on the weakest domain.", "Turn that weakness into a four-week plan."], successCriteria: ["Evidence matches the artifact.", "The weak-domain plan is specific.", "The complete take includes recovery."], reduceDifficultyWhen: ["Use the template chart."], increaseDifficultyWhen: ["Add a collaborator or second guitar role."], relatedSkills: ["reflection", "practice planning", "performance"] }
    ],
    commonMistakes: [
      { id: "mistake.portfolio-overload", symptom: "Every advanced concept is forced into one piece.", likelyCause: "Coverage was confused with musical clarity.", adjustment: "Use three short artifacts and one complete performance." },
      ...
      { id: "mistake.portfolio-plan", symptom: "The next step is vague.", likelyCause: "Weak-domain evidence was not named.", adjustment: "Choose one weakest artifact and define weekly tasks and evidence." }
    ],
    knowledgeChecks: [
      ...
      { id: "check.portfolio-evidence", prompt: "What must analysis do?", options: ["Match the performed material", "Replace performance", "Hide weak areas"], correctAnswer: "Match the performed material", explanation: "Evidence and performance need to agree." },
      { id: "check.portfolio-plan", prompt: "What should the next plan be based on?", options: ["The weakest evidence-bearing domain", "The easiest topic only", "A random new skill"], correctAnswer: "The weakest evidence-bearing domain", explanation: "The plan grows from observed portfolio evidence." }
    ],
    masteryCriteria: [
      ...
      { id: "mastery.portfolio-plan", description: "Write a four-week weak-domain plan with measurable evidence.", verification: "reflection", required: true }
    ],
    reviewRecommendation: "After completion, review the weakest-domain plan weekly and choose Level 5 work from the evidence rather than novelty.",
...
export const levelFourReviewPlans: readonly CurriculumReviewPlan[] = [
  ...
  { id: "review.level-four-creative-portfolio", unitId: "unit.level-four-creative-portfolio", immediateReview: ["List the three portfolio artifacts and weakest domain."], nextSessionReview: ["Run one complete take and revise the weakest artifact."], oneWeekReview: ["Check that performance, analysis, reflection, and practice plan agree."], longTermReview: ["Use portfolio evidence to choose the first Level 5 study focus."] }
];
