...
The files in `docs/education-overhaul/constitution/` are the FretGarden Pedagogical Constitution, Chapters 1–17. Treat them as the authoritative educational specification for this repository.
