...
| ED-005 | OPEN | Formal screen-reader and moderated usability validation are absent | P1 | Technical preflight found and resolved A11Y-FINDING-001 through A11Y-FINDING-003 in `376a1f3`; Evan must still execute the screen-reader/zoom protocol and three representative sessions, then record findings and signoffs | Evan Anderson | Before Gate 4 approval |
